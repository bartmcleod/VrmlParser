...
##Challenge##
One of the first challenges encountered, is caused by how I defined animations in the original VRML file dating from 1997. If for example the green arrow on the top left of the first floor of the house was clicked, the first floor and attic would be moved backwards, revealing the interior of the ground floor. When the corresponding red arrow on the right was clicked, the reverse would happen.
